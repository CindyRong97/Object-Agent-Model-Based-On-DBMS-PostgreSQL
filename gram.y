...
CreateClassxStmt: CREATE CLASSX qualified_name '(' OptTableElementList ')'
        {
          CreateClassxStmt *n = makeNode(CreateClassStmt);
          n->classname = $3;
          n->isdeputy = false;
          n->attrs = $5;
        　$$ = (Node *)n;
...
CreateSelectDeputyClassxStmt: CREATE SELECTDEPUTYCLASSX qualified_name opt_real_attr AS '(' SelectStmt ')'
        {
          CreateClassxStmt *n = makeNode(CreateClassStmt);
          n->classname = $3;
          n->isdeputy = true;
